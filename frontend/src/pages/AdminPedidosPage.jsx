...
export const AdminPedidosPage = () => {
  ...
  return (
    <main className="min-h-screen bg-bg-main pt-28 pb-12 px-4 md:px-6">
      ...
      {/* TABLERO KANBAN: Scroll horizontal automático */}
      <div className="w-full overflow-x-auto pb-8 custom-scrollbar justify-center">

        {/* items-center: Centra las columnas horizontalmente cuando están una debajo de otra (móvil).
            md:items-start: En PC, las alinea arriba del todo para que empiecen a la misma altura.
            md:w-max mx-auto: Centra el bloque entero cuando están en fila.
        */}
        <div className="flex flex-col items-center md:flex-row md:items-start gap-6 w-full md:w-max mx-auto">
